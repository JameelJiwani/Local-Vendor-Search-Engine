    ...
    return ( 
            <div className = "top_section_detail" >
                <Row>
                    ...
                    <Col span={8} className= "textbox-row-right"style={{ textAlign: 'right' }}><a href = "" className = ""  style={{ textAlign: 'right' }}>View Photos</a></Col>
                </Row>
                <Row>
                    ...
                    <Col span={6} className= "textbox-row-right" style={{ textAlign: 'right' }}><a href = "" className = "" >Wishlist</a></Col>
                </Row>
            </div>
        );
